...
public interface AccessController
{
     ...
     */
    default boolean allowSubscribe (DObject object, Subscriber<?> subscriber)
    {
        return false;
    }
     ...
     */
    default boolean allowDispatch (DObject object, DEvent event)
    {
        return event.getSourceOid() == -1; // most objects only permit the server to send events
    }
}
